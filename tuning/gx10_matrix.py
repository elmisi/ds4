...
BASE_UNSET_NAMES = {
    ...
    "DS4_CUDA_SHARED_GATE_UP_WARP1",
    "DS4_CUDA_SHARED_GATE_UP_WARP1_EXACT",
...
MATRIX = {
    ...
    "output_q8_b128": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_OUTPUT_Q8_B128=1)},
        "status": "full-logits output head generic Q8 kernel launched with 128 threads for 128-block rows",
    },
    "attn_b_cublas_min1": {
        "category": "diagnostic",
    ...
    "shared_gate_up_warp1": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_SHARED_GATE_UP_WARP1=1)},
        "status": "shared expert gate/up fused-SwiGLU one-row-per-CTA Q8 kernel",
    },
    "shared_gate_up_warp1_exact": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_SHARED_GATE_UP_WARP1_EXACT=1)},
        "status": "shared expert gate/up one-row-per-CTA Q8 kernel preserving the original lane reduction order",
    },
    ...
    "graph_skip_end_sync": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_GRAPH_SKIP_END_SYNC=1)},
        "status": "skip redundant cudaDeviceSynchronize before the mandatory logits/top-id readback",
    },
