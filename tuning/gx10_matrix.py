...
BASE_UNSET_NAMES = {
    ...
    "DS4_CUDA_INDEXER_DIRECT_ONE_QREUSE2",
...
MATRIX = {
    ...
    "soa_qkv_no_pair": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_Q8_SOA_QKV=1, DS4_METAL_DISABLE_QKV_PAIR_PROJ=1)},
        "status": "QKV SoA with paired q_a/kv projection disabled",
    },
    "soa_shared": {
        "category": "diagnostic",
    ...
    "attn_b_shape4096": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_ATTENTION_OUTPUT_B_SHAPE4096=1)},
        "status": "exact-order attention-output-B 4096x4096 Q8 shape-specialized kernel",
    },
    "attn_a_hwarp16": {
        "category": "prototype",
    ...
    "indexer_qreuse2": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_INDEXER_DIRECT_ONE_QREUSE2=1)},
        "status": "one-token indexer score computes two compressed rows per CTA and reuses q loads",
    },
    "indexer_qreuse4": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_INDEXER_DIRECT_ONE_QREUSE4=1)},
        "status": "one-token indexer score computes four compressed rows per CTA and reuses q loads",
    },
    "indexer_qreuse8": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_INDEXER_DIRECT_ONE_QREUSE8=1)},
        "status": "one-token indexer score computes eight compressed rows per CTA and reuses q loads",
    },
    "indexer_qreuse16": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_INDEXER_DIRECT_ONE_QREUSE16=1)},
        "status": "one-token indexer score computes sixteen compressed rows per CTA and reuses q loads",
    },
    "attention_qreuse2": {
        "category": "prototype",
        "env": {**EXACT_FAST, **env(DS4_CUDA_DECODE_ATTENTION_QREUSE2=1)},
        "status": "one-token ratio-128 attention dot computes two rows per thread and reuses q loads",
    },
    "attention_qreuse4": {
        "category": "prototype",
