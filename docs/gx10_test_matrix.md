...
| `shape_gate_attn_qb_soa_b32` | `DS4_CUDA_MOE_DECODE_GATE_SHAPE2048_CONSTSTRIDE=1 DS4_CUDA_Q8_SOA_QB=1 DS4_CUDA_ATTN_Q_B_SOA_B32_SPECIAL=1` | composed signal: 16.21 vs 16.04 at 256 tokens, repeat 16.18 vs 15.85; selected tokens matched in a 32-step logprob check with ~7.7e-6 max diff, and 2q/4q `ds4-eval` smokes had no pass-count regression | candidate for larger quality/speed gate; not promoted yet |
